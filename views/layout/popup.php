<!-- POPUP | GDPR -->
<section data-lenis-prevent id="popup-gdpr" class="hidden !rounded-0 !m-0 !p-[30px] !max-w-[1024px] w-full [&_.f-button]:hidden">
    <button data-fancybox-close class="absolute top-[30px] right-[30px] w-[50px] aspect-square bg-primary-900 text-white">
        <span class="hover:rotate-[135deg] w-full h-full flex items-center justify-center  duration-450 rotate-45 text-[50px] leading-none block">+</span>
    </button>
