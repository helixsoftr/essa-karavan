...
<header class="h-[150px] lg:h-auto lg:[&.is-static]:!bg-transparent px-[182px] lg:px-[30px] fixed top-0 left-0 w-full bg-white/95 [&.is-static]:!border-none [&.is-static]:!shadow-none shadow-2xl [&.is-hidden]:-translate-y-full [&.is-static]:!bg-[#041722]/5 duration-450 z-[1000] flex items-center justify-center border border-solid border-transparent border-b-[#041722]/20 group/header">
    <div class="max-w-[1920px] mx-auto w-full flex items-center justify-between">
        ...
        <button data-toggle data-target="#mobileMenu" class="z-[1] absolute top-1/2 -translate-y-1/2 right-[30px] hidden bg-primary rounded-[4px] p-[10px] lg:flex flex-col items-center justify-between w-[45px] h-[33px] [&_span]:block [&_span]:w-1/2 [&_span:nth-child(1)]:ml-auto [&_span:nth-child(1)]:origin-top [&.active_span:nth-child(1)]:-rotate-45 [&_span:nth-child(2)]:w-full [&.active_span:nth-child(2)]:w-[120%] [&.active_span:nth-child(2)]:rotate-45 [&_span:nth-child(3)]:mr-auto [&_span:nth-child(3)]:origin-bottom [&.active_span:nth-child(3)]:-rotate-45 [&_span]:h-[2px] [&_span]:bg-white [&.active_span]:bg-white [&_span]:duration-450" style="animation-delay: 1s;">
            <span></span>
            <span></span>
            <span></span>
        </button>
