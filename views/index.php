...
<main class="max-w-[100vw] overflow-hidden">
    <section class="h-svh lg:h-auto w-ful relative">
                ...
                <?php foreach ($heroSlider as $key => $item): ?>
                    <div class="swiper-slide overflow-hidden relative group">
                        <div class="w-full h-full relative">
                            ...
                            <!-- bg  -->
                            <div
                                class="absolute left-0 top-0 w-full h-full bg-gradient-to-b from-[#041722]/50 to-[#041722]/25">
                            </div>
                        </div>
                        <div navbar-spaceFix="padding"
                            class="min-lg:!pt-0 absolute flex flex-col gap-[20px] lg:px-[30px] lg:pt-[63px] top-1/4 lg:top-1/2 lg:-translate-y-1/2 left-[182px] lg:left-0 lg:items-center lg:text-center lg:justify-center lg:w-full z-[40] [&_:is(h1,h2,h3,h4)]:!leading-none [&_:is(h1,h2,h3,h4)]:font-serif [&_:is(h1,h2,h3,h4)]:text-[84px] md:[&_:is(h1,h2,h3,h4)]:text-[32px] [&_:is(h1,h2,h3,h4,h5,h6,p)]:text-white [&_:is(h5,h6,p)]:text-[24px] [&_:is(h5,h6,p)]:lg:text-xl [&_:is(h1,h2,h3,h4)]:max-w-[720px] [&_:is(h1,h2,h3,h4,h5,h6,p)]:opacity-0 [&_:is(h1,h2,h3,h4,h5,h6,p)]:translate-y-full group-[&.swiper-slide-active]:[&_:is(h1,h2,h3,h4,h5,h6,p)]:opacity-100 group-[&.swiper-slide-active]:[&_:is(h1,h2,h3,h4,h5,h6,p)]:translate-y-0 [&_:is(h1,h2,h3,h4)]:duration-1000 [&_:is(h1,h2,h3,h4)]:delay-500 [&_:is(h5,h6,p)]:duration-1000 [&_:is(h5,h6,p)]:delay-1000 transition-all">
                            <h2>
                                <?= $item['title'] ?>
                            </h2>
                            <p>
        ...
        <!-- pagination -->
        <div
            class="lg:hidden absolute z-[40] !left-auto right-[80px] !bottom-[50%] translate-y-1/2 flex flex-col items-center justify-center gap-[24px]">
            <div
        ...
        <!-- rent form -->
        <form id="rentform"
            class="lg:rounded-none lg:w-full lg:static lg:flex lg:flex-col w-[70%] h-[200px] lg:h-auto lg:p-[30px] bg-white rounded-r-[20px] pl-[80px] shadow-2xl z-[40] flex items-center justify-between gap-[100px] lg:gap-[50px] absolute top-[65%] left-0 [&.active]:-translate-x-full duration-450 group/form">
            ...
            <button type="button" data-toggle data-target="#popupForm"
                class="h-full w-[230px] min-lg:p-[10px] lg:w-full bg-primary rounded-r-[20px] lg:rounded-lg flex items-center justify-center gap-[35px]">
    ...
    <section class="w-full h-full pt-[140px] pl-[182px] lg:p-[50px_30px] relative">
        <!-- title and buttons -->
        <div
            class="flex lg:flex-col lg:gap-[30px] lg:items-center lg:w-full items-end justify-between pr-[182px] z-10 lg:px-[30px]">
            ...
            <div class="flex items-center gap-[40px]">
                <button
                    class="worksAndInsta-prev w-[60px] h-[60px] lg:w-[40px] lg:h-[40px] rounded-[12px] bg-dark flex items-center justify-center relative overflow-hidden
                    ...
                    <svg class="lg:scale-75 z-10" xmlns="http://www.w3.org/2000/svg" width="12" height="22"
                ...
                <button
                    class="worksAndInsta-next w-[60px] h-[60px] lg:w-[40px] lg:h-[40px] rounded-[12px] lg:rounded-lg bg-dark flex items-center justify-center relative overflow-hidden before:absolute before:top-0 before:left-0 before:w-0 before:h-full before:bg-primary before:rounded-[12px] lg:before:rounded-lg hover:before:w-full before:duration-450 before:z-0">
                    <svg class="lg:scale-75 z-10" xmlns="http://www.w3.org/2000/svg" width="12" height="22"
                        viewBox="0 0 12 22" fill="none">
    ...
    <section class="w-full h-full pt-[280px] lg:py-[50px] lg:px-[30px] px-[182px] relative">
        ...
        <!-- services -->
        <div
            class="w-full h-[640px] 2xl:h-auto mt-[100px] flex lg:flex-col items-center justify-center gap-[32px] z-10">
    ...
    <section class="pt-[280px] pb-[140px] px-[182px] lg:p-[50px_30px] relative">
        ...
        <!-- content -->
        <div
            class="pt-[100px] lg:pt-[30px] lg:flex lg:flex-col grid grid-cols-[760px,1fr] 3xl:grid-cols-[50%,50%] gap-[80px] items-center">
            ...
            <div>
                ...
                <a href="" aria-label="" title=""
                    class="flex items-center gap-[20px] text-primary text-[24px] 3xl:!text-lg pt-[24px]">
        ...
        <div class="flex lg:flex-col items-center gap-[100px] 2xl:gap-[50px] lg:gap-[30px]">
            ...
            <div class="flex flex-col">
                ...
                <a href="https://www.instagram.com/essakaravan/" target="_blank"
                    class="w-[205px] h-[60px] lg:w-auto lg:h-auto lg:p-[10px_20px] bg-primary rounded-[12px] lg:rounded-lg mt-[62px] flex items-center justify-center text-white text-[18px] relative
            ...
            <div class="worksAndInsta-slider swiper w-full h-full lg:h-[400px] lg:!p-0 py-[190px]">
                <div class="swiper-wrapper">
                    <?php foreach ($instagram as $key => $item): ?>
                        <div
                            class="swiper-slide !h-[400px] lg:!h-auto [&.swiper-slide-next]:-translate-y-[56px] w-full rounded-[26px] pb-[40px] pl-[24px] flex items-end justify-start overflow-hidden relative duration-450 transition-all shadow-xl group">
    ...
    <section class="py-[140px] px-[182px] lg:p-[50px_30px]">
        ...
        <div class="swiper gallery-slider h-full pt-[140px] lg:pt-[30px] w-full">
            <div
                class="swiper-wrapper min-lg:![-webkit-transition-timing-function:linear] min-lg:![-o-transition-timing-function:linear] min-lg:![transition-timing-function:linear]">
                <?php foreach ($gallery as $key => $item): ?>
                    <a href="<?= $item['img'] ?>" data-fancybox="gallery-2"
                        class="swiper-slide w-full h-[570px] lg:h-[300px] overflow-hidden rounded-[26px]
    ...
    <section class="pt-[140px] pb-[280px] pl-[182px] lg:p-[50px_30px]">
            ...
            <div class="swiper-wrapper">
                <?php foreach ($customersExperiences as $key => $item): ?>
                    <div class="swiper-slide">
                        <div
                            class="w-full h-full px-[40px] pt-[60px] pb-[40px] rounded-[12px] lg:rounded-lg bg-[#F5F6F7] relative">
        ...
        <!-- buttons -->
        <div
            class="w-full flex items-center justify-end lg:justify-center gap-[40px] pt-[100px] lg:p-[30px] pr-[182px]">
            <button
                class="customersExperiences-prev w-[60px] h-[60px] lg:w-[40px] lg:h-[40px] rounded-[12px] bg-dark flex items-center justify-center relative overflow-hidden
                    before:absolute before:top-0 before:right-0 before:w-0 before:h-full before:bg-primary before:rounded-[12px] lg:before:rounded-lg lg:rounded-lg hover:before:w-full before:duration-450 before:z-0">
            ...
            <button
                class="customersExperiences-next w-[60px] h-[60px] lg:w-[40px] lg:h-[40px] rounded-[12px] lg:rounded-lg bg-dark flex items-center justify-center relative overflow-hidden
