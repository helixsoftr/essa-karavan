...
<main class="min-h-screen">
        ...
        <div class="relative w-full h-full lg:py-[30px]">
            ...
            <div data-navbarSpaceFix="padding"
                ...
                <div class="flex flex-col lg:w-full">
                    <div
                        class="text-xl font-semibold flex lg:flex-col lg:gap-[30px] lg:items-center lg:text-center justify-between items-end gap-[100px] py-[30px] border-solid border-0 border-b border-white text-white">
                    ...
                    <div
                        class="lg:w-full text-xl font-semibold flex lg:flex-col lg:text-center lg:items-center lg:gap-[50px] justify-between items-end gap-[100px] py-[30px] text-white">
                        <div class="flex flex-col gap-[10px]">
                        ...
                        <a class="relative z-[1] before:absolute before:z-[-1] before:top-[-15px] before:left-[-15px] before:w-[30px] before:h-[30px] before:bg-[#172432] before:rounded-lg after:absolute after:z-[-1] after:bottom-[-15px] after:right-[-15px] after:w-[30px] after:h-[30px] after:bg-[#767E86] after:rounded-lg"
                            href="#">
                            <div class="flex items-center gap-[10px] p-[10px_20px] rounded-xl bg-primary">
                                <svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                                    ...
                                    <g clip-path="url(#clip0_36_172)">
                                        <path
                                            d="M0.708252 4.25008V15.5834L5.66659 12.7501L11.3333 15.5834L16.2916 12.7501V1.41675L11.3333 4.25008L5.66659 1.41675L0.708252 4.25008Z"
                                            stroke="white" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path d="M5.66675 1.41675V12.7501" stroke="white" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M11.3333 4.25V15.5833" stroke="white" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                    </g>
                                    <defs>
    ...
    <section class="relative z-0 w-screen overflow-hidden">
        ...
        <div
            class="relative z-[1] flex lg:flex-col items-center justify-center w-full h-full p-[160px_180px] 2xl:p-[80px] lg:p-[50px_0]">
            <div
                class="flex flex-col gap-[50px] shadow-[0_25px_60px] shadow-black/20 rounded-3xl p-[50px] lg:p-[30px] bg-white">
                <div class="flex flex-col gap-[20px]">
                    <h1 class="text-5xl lg:text-2xl text-[#334033] font-semibold">Bize Ulaşın</h1>
                    <p class="text-lg lg:text-base font-light leading-[30px]">Essa Karavan’a gösterdiğiniz ilgi için
                        teşekkür ederiz. Gereksinimlerinizi daha iyi anlamak ve size en alakalı bilgileri sunmak için
                        lütfen aşağıdaki formu doldurun. Ekibimiz talebinizi inceleyip size en kısa sürede geri dönüş
                        yapacaktır.</p>
                </div>
                <form action="#" class="grid grid-cols-2 lg:flex lg:flex-col gap-[50px]">
                    <div class="flex flex-col gap-[7px]">
                        <label for="name">Adınız</label>
                        <input class="border-solid border-0 border-b border-black/30 focus:border-black duration-450"
                            type="text" name="name" id="name">
                    </div>
                    <div class="flex flex-col gap-[7px]">
                        <label for="surname">Soy Adınız</label>
                        <input class="border-solid border-0 border-b border-black/30 focus:border-black duration-450"
                            type="text" name="surmame" id="surmame">
                    </div>
                    <div class="flex flex-col gap-[7px]">
                    ...
                    <div class="col-span-2 flex flex-col gap-[7px]">
                        ...
                        <textarea class="border-solid border-0 border-b border-black/30 focus:border-black duration-450"
                            type="text" name="message" id="message"></textarea>
                    </div>
                    <div class="col-span-2 flex items-center gap-[20px]">
                        <input type="checkbox"
                            class="lg:grow relative min-lg:min-w-[30px] lg:!min-w-[20px] h-[30px] lg:!h-[20px] lg:aspect-square rounded-full border-[1px] border-solid border-black/16 checked:border-black hover:border-black before:absolute before:top-[50%] before:left-[50%] before:-translate-y-[50%] before:-translate-x-[50%] before:w-0 before:rounded-full before:duration-450 before:h-0 before:bg-primary checked:before:w-[10px] checked:before:h-[10px] cursor-pointer duration-450">
                        <a href="" class="lg:text-sm"> <span class="underline">Şartlar ve Koşulları</span> okuyup kabul
                            ettiğimi onaylayabilirim. </a>
                    </div>
                    <div class="col-span-2 flex items-center gap-[20px]">
                        <input type="checkbox"
                            class="lg:grow relative min-lg:min-w-[30px] lg:!min-w-[20px] h-[30px] lg:!h-[20px] lg:aspect-square rounded-full border-[1px] border-solid border-black/16 checked:border-black hover:border-black before:absolute before:top-[50%] before:left-[50%] before:-translate-y-[50%] before:-translate-x-[50%] before:w-0 before:rounded-full before:duration-450 before:h-0 before:bg-primary checked:before:w-[10px] checked:before:h-[10px] cursor-pointer duration-450">
                        <a href="" class="lg:text-sm">Kişisel verilerimin işlenmesine ilişkin aydınlatma metni uyarınca
                            iletişim bilgilerimin ticari elektronik ileti gönderilmesi ve pazarlama amaçlı olarak
                            benimle iletişime geçilmesi kapsamında kullanılmasına: Onay veriyorum (İletişim türü seçimi:
                            Çağrı, SMS veya E-posta). -posta)</a>
                    </div>
                    <button type="submit"
                        class="group w-max p-[15px_25px] flex items-center justify-center gap-[10px] rounded-lg bg-dark">
                        <span class="font-medium text-white">Gönder</span>
                        <svg class="group-hover:translate-x-1 duration-450" width="14" height="11" viewBox="0 0 14 11"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M12.9732 5.85394L8.30656 10.5206C8.20923 10.6179 8.08121 10.6673 7.95321 10.6673C7.82521 10.6673 7.69719 10.6186 7.59985 10.5206C7.40452 10.3253 7.40452 10.0086 7.59985 9.81325L11.4132 5.99993H0.619873C0.343873 5.99993 0.119873 5.77593 0.119873 5.49993C0.119873 5.22393 0.343873 4.99993 0.619873 4.99993H11.4126L7.5992 1.18658C7.40387 0.991246 7.40387 0.674597 7.5992 0.479264C7.79454 0.28393 8.11123 0.28393 8.30656 0.479264L12.9732 5.14593C13.1686 5.3426 13.1686 5.65861 12.9732 5.85394Z"
                                fill="white" />
                        </svg>
                    </button>
                </form>
